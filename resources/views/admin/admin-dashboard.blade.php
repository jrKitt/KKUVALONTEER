                ...
                <div>
                    ...
                    <section class="flex w-full gap-5">
                        <div class="w-2/3 flex flex-col gap-10">
                            <section
                                class="flex h-40 w-full gap-3 rounded-lg shadow-md"
                            >
                                {{-- Line startContent --}}
                                <div
                                    class="h-full w-3 rounded-xl bg-green-500"
                                ></div>
                                {{-- Line startContent --}}

                                <div
                                    class="flex h-full w-full justify-between p-2"
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <button
                                                class="btn rounded-sm bg-yellow-500/70 text-white"
                                            >
                                                แก้ไขกิจกรรม
                                            </button>
                                        </div>
                        ...
                        <div class="w-1/3 rounded-lg shadow-md">calendar</div>
                    </section>
                </div>
            </div>
        </main>
