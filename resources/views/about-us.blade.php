            ...
            <main>
                <section class="mb-8">
                    <div class="my-6 flex justify-between items-center">
                        <h3 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">กิจกรรมของฉัน</h3>
                        <div class="flex flex-col gap-5 items-end">
                            ...
                            <div class="flex gap-5">
                                <select name="" id=""
                                    class="border rounded-xl border-gray-400 px-2 w-50 py-1 ">
                    ...
                    <div class="my-6 flex justify-between p-4 shadow-sm rounded-md">
                        <div class="flex gap-5">
                            ...
                            <section class="flex flex-col justify-between">
                                ...
                                <div>
                                    <div class="flex justify-between mr-4 text-gray-600 font-medium">
                                        <div>ดำเนินการไปแล้ว</div>
                                        <div>1 ชั่วโมง</div>
                                    </div>
                                    <progress value="33" max="100"
                                        class="progress w-100 h-5 rounded-full"></progress>
                                </div>
                            </section>
                        </div>
                        <div class="flex flex-col justify-between items-center">
                            <div class="text-2xl font-medium text-[#ffc107]">
                                กำลังดำเนินการ
                            </div>
                            <div class="flex gap-2 items-center">
                                ...
                                <a href="#">
                                    <button class="btn border text-white bg-sky-400 hover:bg-sky-600">รายละเอียด</button>
                                </a>
                            </div>
                        </div>
                    </div>
