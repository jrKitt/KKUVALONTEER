...
@section('layout-content')
    <div class="min-h-screen bg-gray-50">
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-8 max-w-1/2 mx-auto">
                <div class="flex flex-col gap-2 bg-red-600 items-start justify-between p-6 rounded-lg text-white">
                    <div class="text-xl">สถานะปัจจุบัน</div>
                    <div class="text-4xl font-bold">40 ชั่วโมง</div>
                    <div class="text-xl ">เป้าหมาย 1200 ชั่วโมง</div>
                </div>
            </div>
            ...
            <main>
                <section class="mb-8">
                    ...
                    <section class="flex flex-wrap gap-3 justify-center">
                        ...
                        <div class="m-2 flex max-lg:flex-col justify-between p-4 shadow-md rounded-md w-fit">
                            <div class="flex gap-5 max-lg:flex-col max-lg:items-center">
                                <section class="w-fit">
                                    <img src="{{ asset('/images/event_1.png') }}" alt="img" class="rounded-md">
                                </section>
                                <section class="flex w-full flex-col gap-1 justify-around">
                                    <div class="flex justify-between w-full max-sm:flex-col-reverse">
                                        <h1 class="text-2xl font-bold max-md:text-lg">ประกอบคอมให้ i have gpu</h1>
                                        <div class="text-2xl max-md:text-lg font-medium text-[#ffc107]">
                                            กำลังดำเนินการ
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex gap-3 text-sm max-sm:flex-col">
                                    ...
                                    <div class="flex justify-between max-lg:flex-col w-full items-end max-lg:items-stretch gap-2">
                                        <div>
                                            ...
                                            <progress value="33" max="100"
                                                class="progress w-100 max-md:w-full h-5 rounded-full max-lg:w-full"></progress>
                                        </div>
                                        <div>
                                            <div class="flex gap-2 items-center justify-center">
                                                ...
                                                <a href="#">
                                                    <button
                                                        class="btn border text-white bg-sky-400 hover:bg-sky-600 text-nowrap">รายละเอียด</button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
